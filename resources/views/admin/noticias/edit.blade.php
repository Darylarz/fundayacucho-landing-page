                    ...
                    <form action="{{ route('admin.config.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" class="form-control" name="facebook_url" value="{{ old('facebook_url', $config->facebook_url) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><i class="bi bi-instagram"></i> Instagram URL</label>
                                <input type="url" class="form-control" name="instagram_url" value="{{ old('instagram_url', $config->instagram_url) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><i class="bi bi-twitter"></i> Twitter/X URL</label>
                                <input type="url" class="form-control" name="twitter_url" value="{{ old('twitter_url', $config->twitter_url) }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><i class="bi bi-youtube"></i> YouTube URL</label>
                                <input type="url" class="form-control" name="youtube_url" value="{{ old('youtube_url', $config->youtube_url) }}">
                            </div>
                        </div>
