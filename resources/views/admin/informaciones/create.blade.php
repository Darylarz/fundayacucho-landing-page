...
@section('title', 'Nueva Información - Panel Administrativo')
...
<div class="row">
    <div class="col-12">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.informaciones.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">JPG, PNG, WEBP. Máx. 2MB</small>
                            </div>
